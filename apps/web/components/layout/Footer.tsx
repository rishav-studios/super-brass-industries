...
import { TextAnimate } from "@super/ui/components/shadcn/text-animate";
...
const FOOTER_LINKS = {
    ...
    socials: [
        ...
        },
        {
            ...
            icon: <svg xmlns="http://www.w3.org/2000/svg" className="size-5 shrink-0" viewBox="0 0 640 640">
                <path
                    className="fill-gray-600 group-hover/custom-link:fill-primary transition-colors duration-300"
        ...
        >
            <defs>
                <radialGradient id={gradId} cx="50%" cy="50%" r="50%">
                    <stop offset="0%" stopColor="#1a2845" stopOpacity="0.85" />
                    <stop offset="30%" stopColor="#1a2845" stopOpacity="0.50" />
                    <stop offset="60%" stopColor="#1a2845" stopOpacity="0.18" />
                    <stop offset="85%" stopColor="#1a2845" stopOpacity="0.05" />
                    <stop offset="100%" stopColor="#1a2845" stopOpacity="0" />
                </radialGradient>
            </defs>
...
const Heading = ({ children }: { children: string }) => {
    return <h2 className="font-heading font-medium text-3xl ">{children}</h2>
}
            ...
            {links.map((link) => (
                <li key={link.id}>
                    <CustomLink
                        ...
                        className="text-gray-600 w-max font-medium text-lg gap-2"
                    >
                        {link.icon && <>{link.icon}</>}
                        {link.label}
                    </CustomLink>
    ...
    return (
        <GridItem>
            ...
            <div className="grid grid-cols-2">
                <div>
                    <h3 className="text-xs text-gray-500 font-medium mb-4">Company</h3>
                    <LinksList links={FOOTER_LINKS.company} />
                </div>
                <div>
                    <h3 className="text-xs text-gray-500 font-medium mb-4">Sectors</h3>
...
const FooterContactInfo = () => {
    ...
    return (
        <GridItem>
            ...
            <div className="space-y-4 text-gray-600 w-max font-medium text-lg">
...
const FooterWorkingHours = () => {
    return (
        <GridItem>
            ...
            <ul className="space-y-4 text-gray-600 w-max font-medium text-lg">
...
const Footer = () => {
    return (
        <footer className="xl:h-[130dvh] bg-white pt-48 relative overflow-hidden">
            <BackgroundLines className="w-[90%] mx-auto" lineColor="#c1c1c1" />

            <GlowOrb id="br" className="opacity-20 -top-150 -right-150" />
            <GlowOrb id="bl" className="opacity-20 -left-150" />
            <Container className="relative z-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 2xl:grid-cols-4 gap-12">
                    ...
                    <Fade>
                        ...
                        <GridItem className="space-y-0">
                            <img src="/logo-main.svg" alt="" className="w-8/10 -translate-y-13" />
                            <p className="text-gray-600 w-8/10 font-normal -translate-y-5">We are a precision engineering firm specializing in brass components with over 20 years of industry experience.</p>
                        </GridItem>
                    </Fade>
                    <Fade delay={.3}>
                ...
                {/* bottom */}
                <TextAnimate className="font-bold text-[clamp(13rem,20vw,312px)] justify-center text-gray-500/20 hidden lg:flex" duration={1} by="character">SUPER</TextAnimate>
            </Container>
